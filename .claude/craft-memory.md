...
toolchain:
  - concern: toolchain
    ...
    confidence: 3
    provenance:
      run: decision-drift-propagation
      commit: cae7206
      date: '2026-08-19'
gate-cmd:
  - concern: gate-cmd
...
findings:
  ...
  - concern: findings
    ...
    provenance:
      ...
      date: '2026-07-31'
  - concern: findings
    file: engine/src/adr-lint-main.js
    severity: high
    pattern: 'a `git grep -z` record parser must anchor FORWARD on both NUL delimiters before locating the record terminator; deriving the terminator from the first newline finds a newline INSIDE the pathname first, and a path whose first byte is a newline then re-parses as an attacker-chosen suffix under an exempt prefix — hiding the hit with the unparsed counter still at 0. Refuse a path carrying a line break outright rather than resyncing at it: resyncing IS the attack'
    confidence: 1
    provenance:
      run: decision-drift-propagation
      commit: cae7206
  ...
  - concern: findings
    file: engine/src/adr-lint-main.js
    severity: high
    pattern: a lint that degrades an unusable manifest to null lets an attacker-controlled read failure SELECT the exempt set — the derived default is WIDER than a manifest that scopes its own frozen tier, so an oversize file or a dangling symlink widens the gate. Absent-at-the-default-path is the zero-config case and stays silent; present-but-unusable must be a finding
    confidence: 1
    provenance:
      run: decision-drift-propagation
      commit: cae7206
  ...
  - concern: findings
    file: engine/src/manifest.js
    severity: high
    pattern: 'a whole-tree glob bound written as a spelling check bounds one form at a time: `{**,}` and `**/?*` carry a non-wildcard segment yet match every path and pass. Test the SEMANTICS — reject a glob that matches every entry of a probe corpus (root file, extensionless file, nested source, deep path)'
    confidence: 1
    provenance:
      run: decision-drift-propagation
      commit: cae7206
      date: '2026-08-19'
  - concern: findings
    file: test/hermetic-suite.test.js
    severity: high
    pattern: node exports NODE_TEST_CONTEXT to child processes, so a nested `node --test` that inherits it emits NOTHING and exits 0 regardless of whether its tests pass — every lane spawning one passes vacuously. Delete the var from the child env AND assert the child produced a real `# pass N` line; exit-status alone cannot tell a green run from a silent one
    confidence: 1
    provenance:
      run: decision-drift-propagation
      commit: cae7206
  ...
  - concern: findings
    file: scripts/ci.sh
    severity: medium
    pattern: 'waiver scope must match SCAN scope: a whole-corpus lint handed merge-base-scoped waiver sources has waivers that last exactly one PR, because on a push to the default branch the touched set is empty and every previously waived finding fails a blocking gate. The touched-diff waiver set is correct only for a touched-diff scanner'
    confidence: 1
    provenance:
      run: decision-drift-propagation
      commit: cae7206
      date: '2026-08-19'
  - concern: findings
    file: engine/src/observability/memory.js
    severity: medium
    pattern: 'when two code paths decide the same thing they must read the SAME indexed lookup: filtering the raw delta in the ADDED path while the index carries a sticky-retraction rule makes the two disagree on a key that is not stored — the reconciler drops it, ADDED resurrects it at FLOOR+STEP'
    confidence: 1
    provenance:
      run: decision-drift-propagation
      commit: cae7206
      date: '2026-08-19'
  - concern: findings
    file: engine/test/adr-lint-main.test.js
    severity: medium
    pattern: a guard written as a two-clause disjunction needs a fixture satisfying exactly ONE clause; when every fixture satisfies both, either clause can be deleted with the suite still green. Same shape as a fixture too thin to distinguish the branch under test from its alternative — the recurring way a test passes for the wrong reason
    confidence: 1
    provenance:
      run: decision-drift-propagation
      commit: cae7206
...
## toolchain
- confidence: 3 | provenance: cae7206 / 2026-08-19
...
## findings
- confidence: 3 | provenance: 5bdbf5a / 2026-08-07
- confidence: 3 | provenance: 5bdbf5a / 2026-08-07
- confidence: 3 | provenance: 5bdbf5a / 2026-08-07
- confidence: 3 | provenance: 5bdbf5a / 2026-08-07
- confidence: 2 | provenance: 9229d3f / 2026-07-27
- confidence: 2 | provenance: f4785cd / 2026-06-23
- confidence: 2 | provenance: c8b7685 / 2026-06-23
- confidence: 2 | provenance: 7b3f4bf / 2026-06-28
- confidence: 2 | provenance: 7b3f4bf / 2026-06-28
- confidence: 3 | provenance: f17d07e / 2026-06-28
- confidence: 2 | provenance: f17d07e / 2026-06-28
- confidence: 3 | provenance: daf7f05 / 2026-07-03
- confidence: 3 | provenance: daf7f05 / 2026-07-03
- confidence: 3 | provenance: daf7f05 / 2026-07-03
- confidence: 3 | provenance: 35cd184 / 2026-07-03
- confidence: 3 | provenance: aac0299 / 2026-07-04
- confidence: 3 | provenance: aac0299 / 2026-07-04
- confidence: 3 | provenance: cb48a0c / 2026-07-04
- confidence: 3 | provenance: cb48a0c / 2026-07-04
- confidence: 3 | provenance: cb48a0c / 2026-07-04
- confidence: 3 | provenance: bb8d2cd / 2026-07-20
- confidence: 3 | provenance: bb8d2cd / 2026-07-20
- confidence: 4 | provenance: 43d5b30 / 2026-07-20
- confidence: 3 | provenance: 8dd16f0 / 2026-07-20
- confidence: 3 | provenance: 545d4d2 / 2026-07-20
- confidence: 4 | provenance: 2eda333 / 2026-07-20
- confidence: 3 | provenance: 27e9c72 / 2026-07-20
- confidence: 3 | provenance: 10a1ecf / 2026-07-24
- confidence: 2 | provenance: 10a1ecf / 2026-07-24
- confidence: 2 | provenance: b63c79c / 2026-07-25
- confidence: 2 | provenance: b63c79c / 2026-07-25
- confidence: 3 | provenance: 9184452 / 2026-07-26
- confidence: 2 | provenance: 9184452 / 2026-07-26
- confidence: 3 | provenance: e59ca69 / 2026-07-27
- confidence: 2 | provenance: be64001 / 2026-07-27
- confidence: 2 | provenance: 7d72b47 / 2026-07-27
...
- confidence: 3 | provenance: f6639d2 / 2026-07-31
- confidence: 4 | provenance: f6639d2 / 2026-07-31
- confidence: 1 | provenance: cae7206 / 2026-08-19
- confidence: 1 | provenance: cae7206 / 2026-08-19
- confidence: 1 | provenance: cae7206 / 2026-08-19
- confidence: 1 | provenance: cae7206 / 2026-08-19
- confidence: 1 | provenance: cae7206 / 2026-08-19
...
## part-sizing
- confidence: 5 | provenance: cae7206 / 2026-08-19
- confidence: 5 | provenance: cae7206 / 2026-08-19
- confidence: 1 | provenance: a4849a1 / 2026-06-26
- confidence: 1 | provenance: a4849a1 / 2026-06-26
- confidence: 1 | provenance: a4849a1 / 2026-06-26
- confidence: 1 | provenance: 3078c6e / 2026-06-26
- confidence: 1 | provenance: 3078c6e / 2026-06-26
- confidence: 1 | provenance: 3078c6e / 2026-06-26
...
- confidence: 1 | provenance: bd4d8d8 / 2026-07-19
- confidence: 1 | provenance: f6639d2 / 2026-07-31
- confidence: 1 | provenance: f6639d2 / 2026-07-31
- confidence: 1 | provenance: f6639d2 / 2026-07-31
- confidence: 1 | provenance: 71d0d40 / 2026-06-29
- confidence: 1 | provenance: 71d0d40 / 2026-06-29
- confidence: 1 | provenance: 71d0d40 / 2026-06-29
- confidence: 1 | provenance: 71d0d40 / 2026-06-29
- confidence: 1 | provenance: 71d0d40 / 2026-06-29
- confidence: 1 | provenance: 71d0d40 / 2026-06-29
- confidence: 1 | provenance: 8501bd2 / 2026-07-04
- confidence: 1 | provenance: 98e267e / 2026-07-04
- confidence: 3 | provenance: cae7206 / 2026-08-19
- confidence: 1 | provenance: cb873b3 / 2026-07-30
- confidence: 1 | provenance: 1a04acc / 2026-07-04
- confidence: 3 | provenance: cae7206 / 2026-08-19
- confidence: 1 | provenance: 6ebaf71 / 2026-07-04
- confidence: 1 | provenance: 19c3379 / 2026-07-04
- confidence: 1 | provenance: 45b7c5a / 2026-07-04
- confidence: 1 | provenance: cae7206 / 2026-08-19
