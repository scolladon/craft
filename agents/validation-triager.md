...
description: Craft validation phase worker. Triages surviving mutants — kills with tests or documents provable equivalence. Spawned by the craft validation phase — do not auto-select.
model: sonnet
---
