...
receipts: [30 design docs](docs/contributing/design/), [29 parted plans](docs/contributing/plan/),
[371 ADRs](docs/contributing/adr/), and [raw telemetry for 25 runs](docs/contributing/metrics-baseline.report.json)
